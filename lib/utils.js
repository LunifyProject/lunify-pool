 ...
 */
 ...
 const validAddress = {
    main: new RegExp('^f+([1-9A-HJ-NP-Za-km-z]{96})$'),
    integratedAddress: new RegExp('^fi+([1-9A-HJ-NP-Za-km-z]{107})$'),
    paymentId: new RegExp('^([0-9a-fA-F]{16}|[0-9a-fA-F]{64})$'),
    subAddress: new RegExp('^ff+([1-9A-HJ-NP-Za-km-z]{96})$')
}
/**
 ...
 **/
 const CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX = 233;
 const CRYPTONOTE_PUBLIC_INTEGRATED_ADDRESS_BASE58_PREFIX = 13671;
 const CRYPTONOTE_PUBLIC_SUBADDRESS_BASE58_PREFIX = 3559;
